"""
Prosperity 4 — Round 1 Trading Algorithm v5.0
...
# Pepper seed = expected Day 1 start price (Day 0 ended at ~13,000)
# EMA will adapt from this seed as actual prices stream in.
PEPPER_SEED = 13_000
...
PRODUCT_CONFIG = {
    "ASH_COATED_OSMIUM": {
        ...
        "position_limit": 80,
        "soft_limit":    60,      # ↑ More capacity than v4b (50) without losing control
        "take_width":    2,       # Proven v4b value — only takes clear mispricings
        "make_width":    3,       # ← KEY FIX: restored from 2 → earns 6 ticks/round-trip
                                  #   vs make_width=2 which only earned 4 ticks.
                                  #   bid@9997 / ask@10003, clamped inside spread.
    ...
    "INTARIAN_PEPPER_ROOT": {
        ...
        "ema_alpha":     0.15,    # Fast adaptation to trend
